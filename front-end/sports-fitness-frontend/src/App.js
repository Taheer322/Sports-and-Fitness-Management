...
//           // some coach contact fields might include email or phone; check both
//           return (c.contact && c.contact.includes(loginEmail)) || (c.email && c.email === loginEmail);
//         });
//         if (coach) {
...
//                     Don't have an account? <span onClick={() => setIsLogin(false)} style={{ cursor: 'pointer' }}>Register here</span>
//                   </p>
//                 </form>
//               ) : (
...
//                   <p className="switch-text">
//                     Already have an account? <span onClick={() => setIsLogin(true)} style={{ cursor: 'pointer' }}>Login here</span>
//                   </p>
//                 </form>
//               )}
//             </div>
...
//           <h2>Welcome, {currentUser?.u_name || currentUser?.name || 'User'}!</h2>
...
//               <div className="form-group">
//                 <label>Address</label>
//                 <textarea value={profileForm.address} onChange={(e) => setProfileForm({ ...profileForm, address: e.target.value })} rows="3" />
//               </div>
//               <div className="form-group">
//                 <label>Daily Calorie Goal</label>
//                 <input type="number" value={profileForm.calories} onChange={(e) => setProfileForm({ ...profileForm, calories: e.target.value })} />
//               </div>
...
//           method: 'PUT',
//           headers: { 'Content-Type': 'application/json' },
//           body: JSON.stringify({ ...booking, status: 'approved' })
//         });
//         alert('Approved!');
//         fetchBookings();
//       } catch (error) {
...
// Dynamic API URL - works for both local development and Azure production
