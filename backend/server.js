...
//   host: 'localhost',
//   user: 'PES2UG24CS814',        // Replace with your MySQL username
//   password: 'taheer@12',        // Replace with your MySQL password
...
//   const { user_id, facility_id, datetime, status } = req.body;
//   const query = 'UPDATE Booking SET user_id = ?, facility_id = ?, datetime = ?, status = ? WHERE booking_id = ?';
  
//   db.query(query, [user_id, facility_id, datetime, status, req.params.id], (err, result) => {
//     if (err) {
